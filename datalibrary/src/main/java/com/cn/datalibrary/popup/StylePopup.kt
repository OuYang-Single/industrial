package com.cn.datalibrary.popup
...
class StylePopup (context: Context, var list:String): CenterPopupView(context) {
    var imgClose: ImageView?=null
    var recyclerView: TextView?=null
    override fun getImplLayoutId(): Int {

        return R.layout.style_popupss
    }

    override fun onCreate() {
        super.onCreate()
        recyclerView = findViewById<TextView>(R.id.tv_title)
        imgClose = findViewById<ImageView>(R.id.img_close)
        recyclerView?.setText(list)
