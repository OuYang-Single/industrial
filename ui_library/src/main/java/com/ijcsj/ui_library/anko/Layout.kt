...
inline var View.corner: Float
    get() = 0F
    set(value) {
        clipToOutline = true
        outlineProvider = object : ViewOutlineProvider() {
            override fun getOutline(p0: View, p1: Outline) {
                p1.setRoundRect(0, 0, p0.width, p0.height, value)
            }
        }
    }
    ...
    set(value) {
        val editorActionListener =
            TextView.OnEditorActionListener { v, actionId, event ->
                value.onEditorAction(v, actionId, event)
            }
...
inline var NestedScrollView.fadeScrollBar: Boolean
    ...
    set(value) {
        isScrollbarFadingEnabled = value
    }
...
var Array<out View>.onClick: (View) -> Unit
    get() {
        return {}
    }
    set(value) {
