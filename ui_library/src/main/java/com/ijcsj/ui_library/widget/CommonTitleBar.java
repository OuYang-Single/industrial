...
import com.ijcsj.ui_library.statusbar.StatusBarUtils;
...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        showBt = array.getBoolean(R.styleable.CommonTitleBar_showBt, false);
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftImageResource = array.getResourceId(R.styleable.CommonTitleBar_leftImageResource, R.drawable.ic_agads);
    ...
    private void initGlobalViews(Context context) {
        ...
        if (showBt){
            setBackgroundResource(R.mipmap.ic_bg_constraint);
        }
    ...
    private void initMainLeftViews(Context context) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            btnLeft.setPadding(PADDING_12, PADDING_12, PADDING_12, PADDING_12);
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            ivSearch.setImageResource(R.drawable.ic_agads);
