...
import com.ijcsj.ui_library.widget.utils.DisplayUtils;
...
public class HiTabBottomLayout extends FrameLayout implements IHiTabLayout<HiTabBottom, HiTabBottomInfo<?>> {
    ...
    //TabBottom高度
    private static float tabBottomHeight = 100;
    ...
    public void inflateInfo(@NonNull List<HiTabBottomInfo<?>> infoList) {
        ...
        for (int i = 0; i < infoList.size(); i++) {
            ...
            params.topMargin =DisplayUtils.dip2px(getContext(),66)+ i * height;
        ...
        LayoutParams flPrams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        flPrams.gravity = Gravity.LEFT;
        addBottomLine();
        addView(ll, flPrams);
