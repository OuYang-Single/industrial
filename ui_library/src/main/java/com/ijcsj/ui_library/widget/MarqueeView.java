...
public class MarqueeView extends HorizontalScrollView implements Runnable{
  ...
  private FrameLayout mainLayout;//跑马灯滚动部分
  ...
  void initView() {
    ...
    mainLayout = (FrameLayout)LayoutInflater.from(context).inflate(R.layout.scroll_content, null);
    this.addView(mainLayout,wm.getDefaultDisplay().getWidth(),
  ...
  public void addViewInQueues(View view, FrameLayout.LayoutParams lp){
    view.setLayoutParams(lp);
    mainLayout.addView(view);
    FrameLayout.LayoutParams lps= (LayoutParams) mainLayout.getLayoutParams();
    view.measure(0, 0);//测量view
    viewWidth = viewWidth + view.getMeasuredWidth() + viewMargin;
    startScroll();
  }
