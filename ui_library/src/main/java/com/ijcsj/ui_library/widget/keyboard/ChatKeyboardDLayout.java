...
import com.ijcsj.ui_library.widget.keyboard.EmoticonEntity;
 ...
 * @author chris
 */
public class ChatKeyboardDLayout extends SoftHandleLayout implements EmoticonsTabBarView
    ...
    public ChatKeyboardDLayout(Context context) {
        super(context, null);
        initView(context);
    }

    public ChatKeyboardDLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    ...
    private void initView(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.keyboard_bar_layout_s, this);
        ...
        btnSend = (TextView) findViewById(R.id.view_keyboard_send_button);
