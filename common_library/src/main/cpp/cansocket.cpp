...
/*JNIEXPORT void JNICALL Java_com_ijcsj_common_1library_can_CanSocket__1close
...
JNIEXPORT jint JNICALL Java_com_ijcsj_common_1library_can_CanSocket__1discoverInterfaceIndex
...
JNIEXPORT jstring JNICALL Java_com_ijcsj_common_1library_can_CanSocket__1discoverInterfaceName
...
JNIEXPORT void JNICALL Java_com_ijcsj_common_1library_can_CanSocket__1bindToSocket
...
JNIEXPORT void JNICALL Java_com_ijcsj_common_1library_can_CanSocket__1sendFrame
...
JNIEXPORT jint JNICALL Java_com_ijcsj_common_1library_can_CanSocket__1fetchInterfaceMtu
...
JNIEXPORT jint JNICALL Java_com_ijcsj_common_1library_can_CanSocket__1getsockopt
...
Java_com_ijcsj_common_1library_can_CanSocket__1fetch_1CAN_1MTU(JNIEnv *env, jclass clazz) {
    {
        return CAN_MTU;
    }
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1fetch_1CAN_1FD_1MTU(JNIEnv *env, jclass clazz) {
    return CANFD_MTU;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1fetch_1CAN_1RAW_1FILTER(JNIEnv *env, jclass clazz) {
    return CAN_RAW_FILTER;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1fetch_1CAN_1RAW_1ERR_1FILTER(JNIEnv *env,
                                                                             jclass clazz) {
    return CAN_RAW_ERR_FILTER;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1fetch_1CAN_1RAW_1LOOPBACK(JNIEnv *env,
                                                                          jclass clazz) {
    return CAN_RAW_LOOPBACK;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1fetch_1CAN_1RAW_1RECV_1OWN_1MSGS(JNIEnv *env,
                                                                                 jclass clazz) {
    return CAN_RAW_RECV_OWN_MSGS;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1fetch_1CAN_1RAW_1FD_1FRAMES(JNIEnv *env,
                                                                            jclass clazz) {
    return CAN_RAW_FD_FRAMES;
}
extern "C"
JNIEXPORT void JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1setsockopt(JNIEnv *env, jclass clazz, jint fd,
                                                           jint op, jint stat) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1openSocketBCM(JNIEnv *env, jclass clazz) {
    return newCanSocket(env, SOCK_DGRAM, CAN_BCM);
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1openSocketRAW(JNIEnv *env, jclass clazz) {
    return newCanSocket(env, SOCK_RAW, CAN_RAW);
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1getCANID_1SFF(JNIEnv *env, jclass clazz,
                                                              jint canid) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1getCANID_1EFF(JNIEnv *env, jclass clazz,
                                                              jint canid) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1getCANID_1ERR(JNIEnv *env, jclass clazz,
                                                              jint canid) {
 	return canid & CAN_ERR_MASK;
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1isSetEFFSFF(JNIEnv *env, jclass clazz, jint canid) {
    return (canid & CAN_EFF_FLAG) != 0 ? JNI_TRUE : JNI_FALSE;
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1isSetRTR(JNIEnv *env, jclass clazz, jint canid) {
    return (canid & CAN_RTR_FLAG) != 0 ? JNI_TRUE : JNI_FALSE;
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1isSetERR(JNIEnv *env, jclass clazz, jint canid) {
    return (canid & CAN_ERR_FLAG) != 0 ? JNI_TRUE : JNI_FALSE;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1setEFFSFF(JNIEnv *env, jclass clazz, jint canid) {
    return canid | CAN_EFF_FLAG;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1setRTR(JNIEnv *env, jclass clazz, jint canid) {
    return canid | CAN_RTR_FLAG;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1setERR(JNIEnv *env, jclass clazz, jint canid) {
    return canid | CAN_ERR_FLAG;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1clearEFFSFF(JNIEnv *env, jclass clazz, jint canid) {
    return canid & ~CAN_EFF_FLAG;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1clearRTR(JNIEnv *env, jclass clazz, jint canid) {
    return canid & ~CAN_RTR_FLAG;
}
extern "C"
JNIEXPORT jint JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1clearERR(JNIEnv *env, jclass clazz, jint canid) {
    return canid & ~CAN_ERR_FLAG;
}
extern "C"
JNIEXPORT void JNICALL
Java_com_ijcsj_common_1library_can_CanSocket__1close(JNIEnv *env, jclass clazz, jint fd) {
    if (close(fd) == -1) {
        throwIOExceptionErrno(env, errno);
    }
}
...
Java_com_ijcsj_common_1library_can_CanSocket__1recvFrame(JNIEnv *env, jclass clazz, jint fd) {
    const int flags = 0;
    ssize_t nbytes;
    struct sockaddr_can addr;
    ...
    const jclass can_frame_clazz = env->FindClass("com/ijcsj/common_library/can/"
                                                  "CanSocket$CanFrame");
